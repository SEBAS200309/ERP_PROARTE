...
@WebMvcTest(value = UsuarioController.class, excludeFilters = @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = SecurityConfig.class))
...
class UsuarioControllerTest extends BaseControllerTest {
        ...
        void getAll_withPermission_returns200WithPagination() throws Exception {
                ...
                List<UsuarioResponse> usuarioResponses = List.of(UsuarioResponse.from(usuario));

                PageRequest pageRequest = PageRequest.of(0, 10);
                Page<UsuarioResponse> pageUsuarioResponses = new PageImpl<>(usuarioResponses, pageRequest,
                                usuarioResponses.size());

                when(usuarioService.getAll(any(Pageable.class))).thenReturn(pageUsuarioResponses);
        ...
        void update_withValidData_returns200() throws Exception {
                ...
                UpdateUsuarioRequest request = new UpdateUsuarioRequest("Updated User", "updated@test.com", ROL_ID,
                                null);
