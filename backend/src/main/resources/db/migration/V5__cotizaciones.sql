...
-- ============================================================
-- Tabla: cotizacion
-- Descripción: Cotizaciones comerciales generadas para clientes
-- ============================================================
...
COMMENT ON COLUMN cotizacion.estado IS 'Estado: borrador, enviada, aprobada, rechazada, vencida';
COMMENT ON COLUMN cotizacion.total IS 'Total calculado automáticamente desde los ítems';

-- ============================================================
-- Tabla: cotizacion_item
-- Descripción: Líneas de detalle de una cotización
-- ============================================================
